...
/**
 * @ngdoc object
 * @name lbServices.EmqUser
 * @header lbServices.EmqUser
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `EmqUser` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#prototype$__findById__accessTokens
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         * Find a related item by id for accessTokens.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `EmqUser` object.)
         * </em>
         */
        "prototype$__findById__accessTokens": {
          params: {
          ...
          url: urlBase + "/emqUsers/:id/accessTokens/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#prototype$__destroyById__accessTokens
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#prototype$__updateById__accessTokens
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#prototype$__get__accessTokens
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         * Queries accessTokens of emqUser.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__get__accessTokens": {
          isArray: true,
          url: urlBase + "/emqUsers/:id/accessTokens",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#prototype$__create__accessTokens
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#prototype$__delete__accessTokens
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#prototype$__count__accessTokens
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         * Counts accessTokens of emqUser.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         */
        "prototype$__count__accessTokens": {
          url: urlBase + "/emqUsers/:id/accessTokens/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#create
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         ...
         */
        "create": {
          url: urlBase + "/emqUsers",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#createMany
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#upsert
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#exists
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/emqUsers/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#findById
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/emqUsers/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#find
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#findOne
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/emqUsers/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#updateAll
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/emqUsers/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#deleteById
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/emqUsers/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#prototype$updateAttributes
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#createChangeStream
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/emqUsers/change-stream",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#login
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        "login": {
          ...
          url: urlBase + "/emqUsers/login",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#logout
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        "logout": {
          ...
          url: urlBase + "/emqUsers/logout",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#confirm
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         ...
         */
        "confirm": {
          url: urlBase + "/emqUsers/confirm",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#resetPassword
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         ...
         */
        "resetPassword": {
          url: urlBase + "/emqUsers/reset",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmqUser#getCurrent
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#updateOrCreate
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#update
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#destroyById
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#removeById
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#getCachedCurrent
         * @methodOf lbServices.EmqUser
         *
         * @description
         *
         * Get data of the currently logged user that was returned by the last
         * call to {@link lbServices.EmqUser#login} or
         * {@link lbServices.EmqUser#getCurrent}. Return null when there
         * is no user logged in or the data of the current user were not fetched
         * yet.
         *
         * @returns {Object} A EmqUser instance.
         */
        R.getCachedCurrent = function() {
          var data = LoopBackAuth.currentUserData;
          return data ? new R(data) : null;
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#isAuthenticated
         * @methodOf lbServices.EmqUser
         *
         * @returns {boolean} True if the current user is authenticated (logged in).
         */
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmqUser#getCurrentId
         * @methodOf lbServices.EmqUser
         *
         * @returns {Object} Id of the currently logged-in user or null.
         */
    ...
    /**
    * @ngdoc property
    * @name lbServices.EmqUser#modelName
    * @propertyOf lbServices.EmqUser
    * @description
    * The name of the model represented by this $resource,
    * i.e. `EmqUser`.
    */
...
/**
 * @ngdoc object
 * @name lbServices.NeuAufNFLX
 * @header lbServices.NeuAufNFLX
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `NeuAufNFLX` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/NeuAufNFLX/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#create
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `NeuAufNFLX` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/NeuAufNFLX",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#createMany
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#upsert
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#exists
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/NeuAufNFLX/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#findById
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/NeuAufNFLX/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#find
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#findOne
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/NeuAufNFLX/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#updateAll
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/NeuAufNFLX/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#deleteById
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#count
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/NeuAufNFLX/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#prototype$updateAttributes
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#createChangeStream
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/NeuAufNFLX/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#updateOrCreate
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#update
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#destroyById
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.NeuAufNFLX#removeById
         * @methodOf lbServices.NeuAufNFLX
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.NeuAufNFLX#modelName
    * @propertyOf lbServices.NeuAufNFLX
    * @description
    * The name of the model represented by this $resource,
    * i.e. `NeuAufNFLX`.
    */
    R.modelName = "NeuAufNFLX";
